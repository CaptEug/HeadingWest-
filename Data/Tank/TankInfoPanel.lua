...
function TankInfoPanel:load()
    CurrentPlace.TankInfoPanelWindow = Window.new(0, wh - 352, 288, 352)
    TankChoosen = {}
    ...
    ManulControl = Buttons.newWindowToolButton(
        ...
        CurrentPlace.TankInfoPanelWindow.buttons,
        256,
        256+64
    )
    ...
    CurrentPlace.TankInfoPanelWindow:use(
        function ()
            if TankChoosen.collider then
                ...
                love.graphics.print('HP', 4, 18)
                love.graphics.rectangle("line", 30, 22, 128, 8)
                love.graphics.rectangle("fill", 32, 24, 124*(TankChoosen.hp/TankChoosen.hp_max), 4)
