...
Ships = {
    ...
    Montana = {
        ...
        el_turret_offset = {
            ...
            {x = -246, y = -109, height = 2, angle = 0, angle1 = 0, fwangle = 35/180*math.pi, get = false, id = 8},
            {x = -192, y = 120, height = 1, angle = 0,angle1 = 0,  fwangle = 35/180*math.pi, get = false, id = 9},
            {x = -246, y = 350, height = 1, angle = 0,angle1 = 0,  fwangle = 35/180*math.pi, get = false, id = 10},
        },
